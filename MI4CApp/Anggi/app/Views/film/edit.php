                ...
                <form action="/film/edit" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control <?= isset($errors['nama_film']) ? 'is-invalid ' : ''; ?>" id="nama_film" name="name_Film" value="<? isset($errors['nama_film']) ? old('nama_film') : $semuafilm["nama_film"]; ?>">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type ="text" class="form-control <?= isset($errors['cover']) ? 'is-invalid' : ''; ?>" id="cover" name="cover" value=" <?= old('cover');?>">
